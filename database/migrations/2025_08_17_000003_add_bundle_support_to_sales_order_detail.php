...
return new class extends Migration
{
    public function up()
    {
        Schema::table('sales_order_detail', function (Blueprint $table) {
            $table->string('item_type')->default('produk')->after('sales_order_id'); // 'produk' or 'bundle'
            ...
            $table->foreignId('parent_detail_id')->nullable()->after('is_bundle_item')->constrained('sales_order_detail')->onDelete('cascade'); // Reference to bundle detail
        });
    }
