...
class QuotationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            $quotations = $query->with(['customer.sales.karyawan', 'details.bundle.items'])->paginate(10)->withQueryString();
    ...
    public function exportPdf($id, $template = 'default')
    {
        try {
            ...
            $whatsappQR = null;
            if ($quotation->user && $quotation->user->karyawan && $quotation->user->karyawan->telepon) {
