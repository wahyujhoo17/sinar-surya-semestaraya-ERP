                ...
                return {
                    ...
                    async fetchData() {
                        ...
                        try {
                            ...
                            this.totalHpp = data.totals?.total_hpp || 0;
                            this.totalLabaKotor = data.totals?.total_laba_kotor || 0;
                            this.rataMarginPersen = data.totals?.rata_margin_persen || 0;
                        } catch (error) {
