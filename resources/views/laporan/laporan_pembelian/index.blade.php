<x-app-layout :breadcrumbs="$breadcrumbs" :currentPage="$currentPage">
    <div class="max-w-full mx-auto py-6 sm:px-6 lg:px-8" x-data="pembelianLaporanController()">
        {{-- Header --}}
        <div
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p class="mt-2 text-sm md:text-base text-gray-600 dark:text-gray-400 max-w-3xl">
                        Laporan pembelian barang lengkap dengan filter dan ekspor. Gunakan fitur filter untuk melihat
                        data yang spesifik.
                    </p>
                </div>
                <div class="flex flex-wrap items-center gap-2">
                    <!-- Excel Dropdown Button -->
                    <div class="relative" x-data="{ excelOpen: false }">
                        <button @click="excelOpen = !excelOpen" type="button"
                        ...
                        <div x-show="excelOpen" @click.away="excelOpen = false"
                            ...
                            class="absolute right-0 mt-2 w-64 rounded-md shadow-lg bg-white dark:bg-gray-700 ring-1 ring-black ring-opacity-5 z-50">
                            <div class="py-1" role="menu">
                                <button @click="detailLevel = 'simple'; exportExcel(); excelOpen = false"
                    ...
                    <div class="relative" x-data="{ pdfOpen: false }">
                        <button @click="pdfOpen = !pdfOpen" type="button"
                        ...
                        <div x-show="pdfOpen" @click.away="pdfOpen = false"
                            x-transition:enter="transition ease-out duration-100"
                            x-transition:enter-start="transform opacity-0 scale-95"
                            x-transition:enter-end="transform opacity-100 scale-100"
                            x-transition:leave="transition ease-in duration-75"
                            ...
                            class="absolute right-0 mt-2 w-64 rounded-md shadow-lg bg-white dark:bg-gray-700 ring-1 ring-black ring-opacity-5 z-50">
                            <div class="py-1" role="menu">
                                <button @click="detailLevel = 'simple'; exportPdf(); pdfOpen = false"
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                            ...
                            <div class="lg:col-span-6">
                                <div
                                    ...
                                    <select id="supplier_filter" x-model="filter.supplier_id"
                                        ...
                                        <template x-for="supplier in supplierList" :key="supplier.id">
                                            <option :value="supplier.id"
                                                x-text="supplier.nama + ' (' + supplier.kode + ')'"></option>
                                        </template>
                                    </select>
                                </div>
                            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mt-1"
                            x-text="formatCurrency(totalPembelian)"></h3>
                    </div>
                </div>
            </div>
            <div
        ...
        <div class="mb-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden"
            ...
            <div class="p-5 border-b border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/60 cursor-pointer"
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400 pl-7">Visualisasi data pembelian dengan
                    berbagai
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <h4 class="text-lg font-medium text-gray-900 dark:text-white"
                                    x-text="chartTypes[selectedChartType]?.title || 'Chart Pembelian'"></h4>
                            ...
                            <div class="chart-container" style="position: relative; height: 400px;">
                                <canvas id="mainPurchaseChart"></canvas>
                            ...
                            <div x-show="selectedChartType === 'monthly' && monthlyStats"
                                ...
                                <div
                                    ...
                                    <div class="text-lg font-bold text-green-700 dark:text-green-300"
                                        x-text="formatCurrency(monthlyStats?.total_annual_purchases || 0)"></div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="text-lg font-bold text-orange-700 dark:text-orange-300"
                                        x-text="formatCurrency(monthlyStats?.avg_monthly_purchases || 0)"></div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="text-xs text-red-600 dark:text-red-400"
                                        x-text="formatCurrency(monthlyStats?.best_month_purchases || 0)"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="chart-container" style="position: relative; height: 250px;">
                            <canvas id="statusPurchaseChart"></canvas>
                        </div>
                    </div>

                    <div
                        class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                        <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Top Suppliers</h4>
                        <div class="chart-container" style="position: relative; height: 250px;">
                    ...
                    <div
                        class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                        <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Produk Terlaris
                            <span class="text-sm font-normal text-gray-500 dark:text-gray-400">(Nilai &
                                Kuantitas)</span>
                        </h4>
                        <div class="chart-container" style="position: relative; height: 250px;">
        ...
        <div
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400 pl-7">
                            Daftar transaksi pembelian berdasarkan filter yang dipilih
                        </p>
                    </div>
            ...
            <div class="p-5">
                @include('laporan.laporan_pembelian._table')
            </div>
        </div>
    </div>
    ...
    @push('scripts')
        ...
        <script>
            function pembelianLaporanController() {
                return {
                    loading: true,
                    pembelianData: [],
                    supplierList: [],
                    ...
                    detailLevel: 'detail', // simple, detail, sangat_detail
                    detailLevelLabel: 'Detail',
                    totalPembelian: 0,
                    totalDibayar: 0,
                    sisaPembayaran: 0,
                    totalItems: 0,
                    ...
                    chartTypes: {
                        ...
                        daily: {
                            ...
                            icon: 'M7 4V2a1 1 0 011-1h4a1 1 0 011 1v2h4a1 1 0 110 2h-1v12a2 2 0 01-2 2H6a2 2 0 01-2-2V6H3a1 1 0 110-2h4z',
                            label: 'Harian'
                        },
                        supplier: {
                            title: 'Top Suppliers',
                    ...
                    async init() {
                        ...
                        this.$nextTick(() => {
                            $('#supplier_filter').select2({
                                ...
                                this.filter.supplier_id = $('#supplier_filter').val();
                            });
                        });
                    },
                    ...
                    async loadSupplierData() {
                        try {
                            // Using direct controller access for suppliers instead of API
                            this.supplierList = @json($suppliers);
                        } catch (error) {
                    ...
                    async fetchData() {
                        this.loading = true;
                        try {
                            const response = await fetch('/laporan/pembelian/data?' + new URLSearchParams({
                                ...this.filter,
                            ...
                            this.pembelianData = data.data || [];
                            this.totalItems = data.total || 0;
                            this.totalPages = data.last_page || 1;
                            this.totalPembelian = data.totals?.total_pembelian || 0;
                    ...
                    async exportExcel() {
                        window.location.href = `/laporan/pembelian/export/excel?` + new URLSearchParams({
                    ...
                    async exportPdf() {
                        window.location.href = `/laporan/pembelian/export/pdf?` + new URLSearchParams({
                            tanggal_awal: this.filter.tanggal_awal,
                            tanggal_akhir: this.filter.tanggal_akhir,
                            supplier_id: this.filter.supplier_id,
                            status_pembayaran: this.filter.status_pembayaran,
                    ...
                    resetFilter() {
                        ...
                        this.$nextTick(() => {
                            $('#supplier_filter').val('').trigger('change');
                        });

                        // Fetch data with reset filters and refresh charts
                        this.currentPage = 1;
                        this.fetchData();
                        this.loadChartData();
                    },
                    ...
                    async loadMainChart() {
                        try {
                            const response = await fetch('/laporan/pembelian/chart-data?' + new URLSearchParams({
                                ...this.filter,
                            ...
                            if (result.success) {
                                ...
                                console.error('Main chart load failed:', result.message);
                            }
                        } catch (error) {
                    ...
                    async loadStatusChart() {
                        try {
                            ...
                            if (result.success) {
                                ...
                                console.error('Status chart load failed:', result.message);
                            }
                        } catch (error) {
                    ...
                    async loadSupplierChart() {
                        try {
                            ...
                            const result = await response.json();
                            if (result.success) {
                                this.renderSupplierChart(result.data);
                            } else {
                                console.error('Supplier chart load failed:', result.message);
                            }
                        } catch (error) {
                    ...
                    async loadProductChart() {
                        try {
                            ...
                            const result = await response.json();
                            if (result.success) {
                                this.renderProductChart(result.data);
                            } else {
                                console.error('Product chart load failed:', result.message);
                            }
                        } catch (error) {
                    ...
                    renderMainChart(data) {
                        ...
                        const canvas = document.getElementById('mainPurchaseChart');
                        if (!canvas) {
                        ...
                        const chartType = ['supplier', 'status'].includes(this.selectedChartType) ? 'doughnut' :
                    ...
                    displayMonthlyChartInfo(meta) {
                        ...
                        this.monthlyStats = {
                            year: meta.year,
                            total_annual_purchases: meta.total_annual_purchases,
                            total_annual_orders: meta.total_annual_orders,
                            avg_monthly_purchases: meta.avg_monthly_purchases,
                            best_month: meta.best_month,
                            best_month_purchases: meta.best_month_purchases
                        };

                        // Also log for debugging
                        console.log('Monthly Chart Stats:', {
                            year: meta.year,
                            totalPurchases: this.formatCurrency(meta.total_annual_purchases),
                            totalOrders: meta.total_annual_orders,
                            avgMonthlyPurchases: this.formatCurrency(meta.avg_monthly_purchases),
                            bestMonth: meta.best_month,
                            bestMonthPurchases: this.formatCurrency(meta.best_month_purchases)
                        });
                    },

                    renderStatusChart(data) {
                        // Check if canvas element exists
                        const canvas = document.getElementById('statusPurchaseChart');
                        if (!canvas) {
                    ...
                    renderSupplierChart(data) {
                        console.log('Rendering supplier chart with data:', data);
                        ...
                        const ctx = canvas.getContext('2d');
                        if (!ctx) {
                            console.warn('Could not get 2D context for supplier chart');
                            return;
                        }

                        if (this.charts.supplierChart) {
                            this.charts.supplierChart.destroy();
                        }

                        // Check if data has values or shows "Tidak ada data"
                        if (!data.labels || data.labels.length === 0 ||
                            (data.labels.length === 1 && data.labels[0] === 'Tidak ada data')) {
                            console.warn('No supplier data available');

                            // Create a simple "no data" chart
                            this.charts.supplierChart = new Chart(ctx, {
                                type: 'bar',
                                data: {
                        ...
                        // Limit to top 5 suppliers if more than 5
                        let chartData = {
                            ...data
                        };
                        ...
                        // Always use horizontal bar chart for supplier data
                        this.charts.supplierChart = new Chart(ctx, {
                            type: 'bar',
                            data: chartData,
                            options: {
                        ...
                        console.log('Supplier chart rendered successfully as horizontal bar chart');
                    },

                    renderProductChart(data) {
                        console.log('Rendering product chart with data:', data);
                        ...
                        const ctx = canvas.getContext('2d');
                        if (!ctx) {
                            console.warn('Could not get 2D context for product chart');
                            return;
                        }
                        ...
                        if (data.labels && data.labels.length > 10) {
                            chartData = {
                                ...
                                datasets: [{
                                    ...data.datasets[0],
                                    data: data.datasets[0].data.slice(0, 10),
                                    backgroundColor: data.datasets[0].backgroundColor ? data.datasets[0]
                                        .backgroundColor.slice(0, 10) : undefined,
                                    borderColor: data.datasets[0].borderColor ? data.datasets[0].borderColor.slice(
                                        0, 10) : undefined
                                }]
                            };
                        ...
                        // Always use horizontal bar chart for product data
                        this.charts.productChart = new Chart(ctx, {
                            type: 'bar',
                            data: chartData,
                            options: {
                                    ...
                                    tooltip: {
                                        callbacks: {
                                            label: (context) => {
                                                ...
                                                const metadata = data.metadata ? data.metadata[dataIndex] : null;

                                                if (metadata) {
                                                    const quantity = metadata.quantity || 0;
                                                    const unit = metadata.unit || 'unit';
                                                    const orders = metadata.orders || 0;

                                                    return [
                                                        `${context.label}`,
                                                        `Nilai: ${this.formatCurrency(context.parsed.x)}`,
                                                        `Jumlah: ${quantity.toLocaleString('id-ID')} ${unit}`,
                                                        `Transaksi: ${orders} order`
                                                    ];
                                                } else {
                                                    return `${context.label}: ${this.formatCurrency(context.parsed.x)}`;
                                                }
                        ...
                        console.log('Product chart rendered successfully as horizontal bar chart');
                    },
                    ...
                    downloadChart() {
                        if (this.charts.mainChart) {
                            ...
                            link.download = `purchase-chart-${this.selectedChartType}-${new Date().getTime()}.png`;
            ...
            // Ensure DOM is ready before initializing Alpine
            document.addEventListener('DOMContentLoaded', function() {
                // Component is already defined above, Alpine will automatically initialize it
            });
        </script>
    @endpush
</x-app-layout>
