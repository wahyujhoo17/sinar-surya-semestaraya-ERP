<table>
    <tr>
        <td colspan="6" style="font-size: 16px; font-weight: bold; text-align: center;">LAPORAN PEMBELIAN RINGKAS</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="font-weight: bold; background-color: #4F46E5; color: white; text-align: center;">Supplier</td>
        <td style="font-weight: bold; background-color: #4F46E5; color: white; text-align: center;">Jumlah Transaksi
        </td>
        <td style="font-weight: bold; background-color: #4F46E5; color: white; text-align: center;">Total Pembelian
        </td>
    ...
    @foreach ($groupedData as $data)
        <tr>
            ...
            <td>{{ $data['supplier']->nama ?? 'Unknown' }}<br>{{ $data['supplier']->kode ?? '-' }}</td>
            <td style="text-align: center;">{{ $data['total_transaksi'] }}</td>
            <td style="text-align: right;">{{ $data['total_pembelian'] }}</td>
    ...
    <tr style="background-color: #DBEAFE; font-weight: bold;">
        ...
        <td style="text-align: right;">{{ $totalPembelian }}</td>
