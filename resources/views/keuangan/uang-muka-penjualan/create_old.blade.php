        ...
        <form action="{{ route('keuangan.uang-muka-penjualan.store') }}" method="POST" id="uang-muka-form"
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8">
                ...
                <div class="xl:col-span-1">
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden form-card sticky top-6">
                        <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 relative">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white flex items-center">
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                ...
                                <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                    ...
                                    <div class="font-medium text-gray-900 dark:text-white" x-text="selectedCustomer ? $('#customer_id option:selected').text() || 'Belum dipilih' : 'Belum dipilih'">
                                        Belum dipilih
                                    </div>
                                </div>
                                ...
                                <div class="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                    ...
                                    <div class="text-xl font-bold text-blue-900 dark:text-blue-100" x-text="formatCurrency(jumlah)">
                                        Rp 0
                                    </div>
                                </div>
                                ...
                                <div class="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                    <div class="text-sm text-green-600 dark:text-green-400 mb-1">Metode Pembayaran</div>
                                ...
                                {{-- Sales Order Info --}}
                                <div class="p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg" x-show="selectedSalesOrder">
                                    ...
                                    <div class="font-medium text-yellow-900 dark:text-yellow-100">
                                        <template x-if="selectedSalesOrder">
                                            <span x-text="filteredSalesOrders.find(so => so.id == selectedSalesOrder)?.nomor || 'SO tidak ditemukan'"></span>
                                        </template>
                                    </div>
                                </div>
                            </div>
