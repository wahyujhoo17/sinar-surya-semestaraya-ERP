        ...
        <form action="{{ route('keuangan.uang-muka-penjualan.store') }}" method="POST" id="uang-muka-form"
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-lg text-gray-600 dark:text-gray-400">
                                Buat pencatatan uang muka baru dari customer
                            </p>
                        </div>
                    </div>
                    <div class="mt-4 sm:mt-0 flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                        ...
                        <button type="button" @click="submitForm()"
                            ...
                            <span x-text="isSubmitting ? 'Menyimpan...' : 'Simpan Uang Muka'"></span>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8">
                ...
                <div class="xl:col-span-2 space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden form-card">
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="customer_id" id="customer_id" x-model="selectedCustomer"
                                        class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white transition-all duration-200"
                                        required>
                                ...
                                <div>
                                    <label for="sales_order_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    ...
                                    <select name="sales_order_id" id="sales_order_id" x-model="selectedSalesOrder"
                                        ...
                                        <template x-for="so in filteredSalesOrders" :key="so.id">
                                            <option :value="so.id" x-text="`${so.nomor} - ${formatCurrency(so.total)}`"></option>
                                        </template>
                                    </select>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" name="jumlah" id="jumlah" x-model="jumlah"
                                            value="{{ old('jumlah') }}" step="0.01" min="0.01"
                                ...
                                {{-- Nomor Referensi --}}
                                <div>
                                    <label for="nomor_referensi" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        Nomor Referensi
                                    </label>
                                    <input type="text" name="nomor_referensi" id="nomor_referensi" value="{{ old('nomor_referensi') }}"
                                        class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white transition-all duration-200"
                    ...
                    {{-- Payment Method Card --}}
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden form-card payment-section">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    ...
                                    <label class="payment-method-card cursor-pointer">
                                        <input type="radio" name="metode_pembayaran" value="kas" x-model="metode"
                                            class="sr-only" {{ old('metode_pembayaran') === 'kas' ? 'checked' : '' }}>
                                        <div class="p-4 border-2 rounded-xl transition-all duration-200"
                                            :class="metode === 'kas' ? 'border-green-500 bg-green-50 dark:bg-green-900/20' : 'border-gray-200 dark:border-gray-600 hover:border-green-300'">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-xs text-gray-500 dark:text-gray-400">Penerimaan tunai</div>
                                                </div>
                                            </div>
                                        </div>
                                    </label>
                                    ...
                                    {{-- Bank Option --}}
                                    <label class="payment-method-card cursor-pointer">
                                        <input type="radio" name="metode_pembayaran" value="bank" x-model="metode"
                                            class="sr-only" {{ old('metode_pembayaran') === 'bank' ? 'checked' : '' }}>
                                        <div class="p-4 border-2 rounded-xl transition-all duration-200"
                                            :class="metode === 'bank' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-200 dark:border-gray-600 hover:border-blue-300'">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    <div class="text-sm font-medium text-gray-900 dark:text-white">Bank Transfer</div>
                            ...
                            <div id="kas_field" style="display: none;">
                                <label for="kas_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Pilih Kas
                                    <span class="text-red-500">*</span>
                                </label>
                            ...
                            <div id="bank_field" style="display: none;">
                                <label for="rekening_bank_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Pilih Rekening Bank
                                    <span class="text-red-500">*</span>
                                </label>
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                <div class="flex justify-between items-center py-2 border-b border-gray-100 dark:border-gray-700">
                                    <dt class="text-sm text-gray-600 dark:text-gray-400">Nomor:</dt>
                                    <dd class="text-sm font-medium text-gray-900 dark:text-white">{{ $nomor }}</dd>
                                </div>
                                <div class="flex justify-between items-center py-2 border-b border-gray-100 dark:border-gray-700">
                                    <dt class="text-sm text-gray-600 dark:text-gray-400">Customer:</dt>
                                    <dd class="text-sm font-medium text-gray-900 dark:text-white">
                                        <span x-text="selectedCustomer ? $refs.customerSelect.options[$refs.customerSelect.selectedIndex].text : 'Belum dipilih'"></span>
                                    </dd>
                                </div>
                                <div class="flex justify-between items-center py-2 border-b border-gray-100 dark:border-gray-700">
                                    <dt class="text-sm text-gray-600 dark:text-gray-400">Jumlah:</dt>
                                    <dd class="text-lg font-bold text-indigo-600 dark:text-indigo-400">
                                        <span x-text="formatCurrency(jumlah || 0)"></span>
                                    </dd>
                                </div>
                                <div class="flex justify-between items-center py-2">
                                    <dt class="text-sm text-gray-600 dark:text-gray-400">Metode:</dt>
                                    <dd class="text-sm font-medium text-gray-900 dark:text-white">
                                        <span x-text="metode ? (metode === 'kas' ? 'Kas' : 'Bank Transfer') : 'Belum dipilih'"></span>
                                    </dd>
                                </div>
                            </div>
                            ...
                            <div class="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800">
                                ...
                                <ul class="text-xs text-blue-800 dark:text-blue-300 space-y-1">
                                    <li>• Uang muka akan menambah saldo kas/bank yang dipilih</li>
                                    <li>• Dapat diaplikasikan ke invoice customer nanti</li>
                                    <li>• Jurnal akan dibuat otomatis saat konfirmasi</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            {{-- Hidden reference to customer select for summary --}}
            <select x-ref="customerSelect" style="display: none;">
                <option value="">Belum dipilih</option>
                @foreach($customers as $customer)
                    <option value="{{ $customer->id }}">{{ $customer->nama ?: $customer->company }}</option>
                @endforeach
            </select>
