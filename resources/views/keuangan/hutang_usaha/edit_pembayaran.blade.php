    ...
    <div class="max-w-full mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <form action="{{ route('keuangan.pembayaran-hutang.update', $payment->id) }}" method="POST"
            x-data="{
                ...
                jumlahBayar: {{ old('jumlah', $payment->jumlah) }},
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <div class="relative rounded-md shadow-sm">
                                    ...
                                    <input type="hidden" name="jumlah" :value="jumlahBayar">
                                    <input type="text" id="jumlah_display" required
                                        :value="formatRupiahInput(jumlahBayar)"
                                        @input="handleJumlahInput($event)"
                                        placeholder="0"
                                        class="pl-10 font-bold border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-amber-500 focus:border-amber-500 block w-full rounded-md shadow-sm font-mono">
                                </div>
