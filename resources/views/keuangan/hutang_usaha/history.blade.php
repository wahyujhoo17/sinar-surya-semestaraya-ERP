                                ...
                                @if ($transaction['type'] == 'payment')
                                    ...
                                    <div class="mb-8 flex items-start relative">
                                        ...
                                        <div
                                            ...
                                            <div class="mt-4 ml-8">
                                                <a href="{{ route('keuangan.pembayaran-hutang.show', $bayar->id) }}"
                                                    class="inline-flex items-center justify-center h-8 w-8 rounded-lg hover:bg-emerald-100 dark:hover:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800 transition-colors"
                                                    title="Lihat Detail">
