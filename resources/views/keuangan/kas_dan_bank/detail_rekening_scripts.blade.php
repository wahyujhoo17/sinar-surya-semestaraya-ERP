@push('scripts')
    ...
    <script>
        ...
        window.showTransactionDetail = function(id, noRef, tanggal, keterangan, jenis, jumlah, createdAt, updatedAt,
            relatedId, relatedType) {
            console.log('showTransactionDetail called with:', {
                id,
                noRef,
                tanggal,
                jenis,
            ...
            // Format the date
            console.log('Formatting date:', tanggal);
            let formattedDate;
            try {
            ...
            console.log('Formatting created date:', createdAt);
            ...
            // Set the details
            subtitle.textContent = `No. Ref: ${noRef}`;
            detailReference.textContent = noRef;
            ...
            setTimeout(() => {
                ...
                console.log('Found modal panel:', modalPanel);
