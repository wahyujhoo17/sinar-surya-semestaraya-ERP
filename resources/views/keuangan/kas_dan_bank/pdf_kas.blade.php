...
<head>
    <meta charset="UTF-8">
    <title>Laporan Transaksi Kas - {{ $kas->nama }}</title>
    <style>
        @page {
            margin: 20mm 22mm;
        }
...
<body>
    ...
    <div class="header">
        ...
        <h2>{{ $kas->nama }}</h2>
        @if ($kas->deskripsi)
            <p class="subtitle">{{ $kas->deskripsi }}</p>
        @endif
    </div>
    ...
    <div class="info-section">
        <table class="info-table">
            ...
            <tr>
                ...
                <td>:</td>
                <td style="font-weight: bold; color: #1a202c;">Rp {{ number_format($kas->saldo, 0, ',', '.') }}</td>
            </tr>
            <tr>
                <td>Status Kas</td>
                <td>:</td>
                <td>
                    <span style="font-weight: bold; color: {{ $kas->is_aktif ? '#15803d' : '#dc2626' }};">
