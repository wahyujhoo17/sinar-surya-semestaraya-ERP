                ...
                <div
                    ...
                    <div class="flex flex-col h-full justify-center">
                        ...
                        <div class="mt-4 flex space-x-3">
                            <button type="button"
                                onclick="window.dispatchEvent(new CustomEvent('open-transaksi-modal', {detail: {account_type: 'kas', account_id: {{ $kas->id }}}}))"
            ...
            <div class="p-4 sm:p-5">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                        ...
                        {{-- <button type="button"
                            onclick="window.dispatchEvent(new CustomEvent('open-transaksi-modal', {detail: {account_type: 'kas', account_id: {{ $kas->id }}}}))"
                            class="inline-flex items-center justify-center px-4 py-2 bg-primary-600 border border-transparent rounded-md shadow-sm text-sm font-medium text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all duration-200 transform hover:-translate-y-0.5">
                        ...
                        <form id="filterForm" action="{{ route('keuangan.kas-dan-bank.kas', $kas->id) }}"
                ...
                <div id="tableContent" x-data="{}">
                    @if ($transaksi->isEmpty())
                        <div class="flex flex-col items-center justify-center py-16">
                            ...
                            <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-100">Belum ada transaksi kas
                            </h3>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                    @foreach ($transaksi as $trx)
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/40 transition-colors duration-150 ease-in-out cursor-pointer hover:shadow-sm relative transform hover:scale-[1.01]"
                                            ...
                                            data-jenis="{{ $trx->jenis }}" data-jumlah="{{ $trx->jumlah }}"
        ...
        <script>
            ...
            const initModal = () => {
                if (typeof window.modalTransaksiManager === 'function') {
                    ...
                    console.log('Transaction modal initialized successfully in detail kas');
                } else {
