                            ...
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <path fill-rule="evenodd"
                                        d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2 2zm8-2v2H7V7a3 3 0 016 0z"
                                        clip-rule="evenodd" />
                                </svg>
                            </div>
                        </div>
    ...
    <script>
        function purchaseRequestForm() {
            return {
                ...
                initSelect2All() {
                    // Inisialisasi Select2 pada semua select produk
                ...
                updateProdukDetail(index) {
                    ...
                    if (produkId) {
                        // Cari option pada select yang sesuai index
                        const selects = document.querySelectorAll('.select2-dropdown-dynamic');
