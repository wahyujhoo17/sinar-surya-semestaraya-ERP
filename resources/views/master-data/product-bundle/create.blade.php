<x-app-layout :breadcrumbs="$breadcrumbs" :currentPage="$currentPage">
    <div class="min-h-screen px-4 py-6 sm:px-6 lg:px-8" x-data="bundleForm()">
        {{-- Header --}}
        <div class="mb-6">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                <div>
                    <h1 class="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">Tambah Product
                        Bundle</h1>
                    <p class="mt-1 text-sm md:text-base text-gray-600 dark:text-gray-400">
                        Buat paket produk baru dengan harga khusus
                    </p>
                </div>
        ...
        <form id="bundleForm" method="POST" action="{{ route('master.product-bundle.store') }}"
                        ...
                        <div class="p-4 lg:p-6 space-y-4 lg:space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
                                <div>
                                    ...
                                    <input type="text" name="kode" value="{{ old('kode', $kode) }}" required
                            ...
                            <div>
                                ...
                                <textarea name="deskripsi" rows="3"
                                    class="w-full px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white @error('deskripsi') border-red-500 @else border-gray-300 dark:border-gray-600 @enderror">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" name="harga_bundle" value="{{ old('harga_bundle') }}"
                                            ...
                                            :class="{ 'ring-2 ring-blue-300 border-blue-300': !manualPriceEdit &&
                                                isCalculating, 'ring-2 ring-amber-300 border-amber-300': manualPriceEdit }">
                                    </div>
                                    @error('harga_bundle')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <label class="flex items-center cursor-pointer" x-data="{ isActive: {{ old('is_active', 1) ? 'true' : 'false' }} }">
