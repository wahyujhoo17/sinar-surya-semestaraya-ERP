                    ...
                    <div x-data="{ statusDropdownOpen: false, confirmModal: false, newStatus: '{{ $quotation->status }}', currentStatus: '{{ $quotation->status }}' }">
                        <div class="relative">
                            ...
                            <div x-show="statusDropdownOpen" @click.away="statusDropdownOpen = false"
                                ...
                                <!-- Disetujui option - available if current status is draft or dikirim (but disabled if current) -->
                                <div class="py-1" x-show="['draft', 'dikirim', 'disetujui'].includes(currentStatus)">
                                ...
                                <div class="py-1" x-show="['draft', 'dikirim', 'ditolak'].includes(currentStatus)">
                                        ...
                                        <div class="sm:flex sm:items-start">
                                            <div class="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full"
                                                :class="{
                                                    ...
                                                    'bg-emerald-100 dark:bg-emerald-900/20': newStatus == 'disetujui',
                                            ...
                                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                ...
                                                <div class="mt-2">
                                                    <p class="text-sm text-gray-500 dark:text-gray-400">
                                                        Apakah Anda yakin ingin mengubah status quotation ini menjadi
                                                        <span
                                                            :class="{
                            ...
                            <tfoot class="bg-gray-50 dark:bg-gray-700">
                                ...
                                <tr>
                                    <td colspan="7"
                                        ...
                                        Total:</td>
                                    <td colspan="2"
                                        class="px-6 py-4 text-lg font-bold text-gray-900 dark:text-white">
                                            ...
                                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                                ...
                                                <td class="px-4 py-3 whitespace-nowrap">
                                                    @php
                                                        ...
                                                        $class =
                                                            $statusClass[$salesOrder->status] ?? $statusClass['draft'];
                                                    @endphp
                                                    <span
