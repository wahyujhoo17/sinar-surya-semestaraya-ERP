                    ...
                    <div>
                        ...
                        <select name="customer_id" id="customer_id" required
                            ...
                            @foreach ($customers ?? [] as $customer)
                                <option value="{{ $customer->id }}" data-is-sales="{{ $customer->sales_id == auth()->id() ? '1' : '0' }}" @if (old('customer_id') == $customer->id) selected @endif>
                                                ...
                                                <div class="flex items-center justify-between text-sm">
                                                    ...
                                                    <div
                                                        ...
                                                        <span class="font-semibold text-gray-700 dark:text-gray-300"
                                                            x-text="formatRupiah(childItem.subtotal || 0)"></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </template>
                ...
                <div class="px-6 py-5 grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-4">
                    ...
                    <div
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <input type="hidden" name="diskon_nominal" :value="$data.diskon_global_nominal">
                        </div>
                        ...
                        <div class="flex justify-between items-center mt-2">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <input type="text" inputmode="numeric"
                                    ...
                                    placeholder="0">
                                <input type="hidden" name="ongkos_kirim" :value="$data.ongkosKirim">
                            </div>
                        </div>
