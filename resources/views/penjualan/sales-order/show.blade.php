                                    ...
                                    <div class="p-2">
                                        ...
                                        <a href="{{ route('penjualan.sales-order.pdf', $salesOrder->id) }}"
                                            ...
                                            <div>
                                                ...
                                                <div class="text-xs text-gray-500 dark:text-gray-400">Template default</div>
                                            </div>
                                        </a>
                                        ...
                                        <a href="{{ route('penjualan.sales-order.pdf', [$salesOrder->id, 'indo-atsaka']) }}"
                                            ...
                                            <div>
                                                ...
                                                <div class="text-xs text-gray-500 dark:text-gray-400">Template biru-merah</div>
                                            </div>
                                        </a>
                                        ...
                                        <a href="{{ route('penjualan.sales-order.pdf', [$salesOrder->id, 'hidayah-cahaya']) }}"
                                            ...
                                            <div>
                                                ...
                                                <div class="text-xs text-gray-500 dark:text-gray-400">Template hijau</div>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <form @submit.prevent="confirmModal = true">
                                <div class="mb-4">
                                    ...
                                    <select x-model="formData.status_pembayaran" id="status_pembayaran"
                                        ...
                                        <option value="belum_bayar"
                                            ...
                                            Belum Bayar</option>
                                        <option value="sebagian" :selected="formData.status_pembayaran == 'sebagian'">
                                            Sebagian</option>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select x-model="formData.status_pengiriman" id="status_pengiriman"
                                        ...
                                        <option value="sebagian" :selected="formData.status_pengiriman == 'sebagian'">
                                            Sebagian</option>
                                        <option value="dikirim" :selected="formData.status_pengiriman == 'dikirim'">
                                            Dikirim
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div
                                ...
                                <div class="bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                    <form method="POST"
                                        ...
                                        <input type="hidden" name="catatan_status" :value="formData.catatan_status">
                                        <button type="submit"
