                    ...
                    <div class="flex flex-wrap gap-2 mt-4 lg:mt-0 lg:ml-4 dropdown-container" x-data="{
                        ...
                        @if (auth()->user()->hasPermission('sales_order.print'))
                            <div class="relative" x-data="{ printDropdownOpen: false }">
                                ...
                                <!-- Dropdown menu -->
                                <div x-show="printDropdownOpen" @click.away="printDropdownOpen = false"
                                    x-transition:enter="transition ease-out duration-100"
                                    x-transition:enter-start="transform opacity-0 scale-95"
                                    x-transition:enter-end="transform opacity-100 scale-100"
                                    x-transition:leave="transition ease-in duration-75"
                                    x-transition:leave-start="transform opacity-100 scale-100"
                                    x-transition:leave-end="transform opacity-0 scale-95" class="dropdown-print">

                                    <div class="p-2">
                                        <div
                                            class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide px-3 py-2">
                                            Pilih Template PDF
                                        </div>

                                        <!-- Default Template -->
                                        <a href="{{ route('penjualan.sales-order.pdf', $salesOrder->id) }}"
                                            target="_blank"
                                            class="flex items-center px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-md transition-colors duration-150">
                                            <div class="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
                                            <div>
                                                <div class="font-medium">PT Sinar Surya Semestaraya</div>
                                                {{-- <div class="text-xs text-gray-500 dark:text-gray-400">Template default
                                                </div> --}}
                                            </div>
                                        </a>

                                        <!-- Indo Atsaka Template -->
                                        <a href="{{ route('penjualan.sales-order.pdf', [$salesOrder->id, 'indo-atsaka']) }}"
                                            target="_blank"
                                            class="flex items-center px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-md transition-colors duration-150">
                                            <div class="w-2 h-2 bg-red-500 rounded-full mr-3"></div>
                                            <div>
                                                <div class="font-medium">PT Indo Atsaka Industri</div>
                                                {{-- <div class="text-xs text-gray-500 dark:text-gray-400">Template
                                                    biru-merah</div> --}}
                                            </div>
                                        </a>

                                        <!-- Hidayah Cahaya Template -->
                                        <a href="{{ route('penjualan.sales-order.pdf', [$salesOrder->id, 'hidayah-cahaya']) }}"
                                            target="_blank"
                                            class="flex items-center px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-md transition-colors duration-150">
                                            <div class="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
                                            <div>
                                                <div class="font-medium">PT Hidayah Cahaya Berkah</div>
                                                {{-- <div class="text-xs text-gray-500 dark:text-gray-400">Template hijau
                                                </div> --}}
                                            </div>
                                        </a>
                                    </div>
                        ...
                        @if (auth()->user()->hasPermission('sales_order.change_status'))
                            <div class="relative">
                                ...
                                <div x-show="statusDropdownOpen" @click.away="statusDropdownOpen = false"
                                    ...
                                    x-transition:leave="transition ease-in duration-75"
                                    x-transition:leave-start="transform opacity-100 scale-100"
                                    x-transition:leave-end="transform opacity-0 scale-95" class="dropdown-status">
                                    <div class="p-4">
                                        <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Ubah Status
                                        </h3>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select x-model="formData.status_pembayaran" id="status_pembayaran"
                                                    ...
                                                    <option value="sebagian"
                                                        ...
                                                        Sebagian</option>
                                                    <option value="lunas"
                                                        :selected="formData.status_pembayaran == 'lunas'">
                                                        Lunas
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="mb-4">
                                                ...
                                                <select x-model="formData.status_pengiriman" id="status_pengiriman"
                                                    ...
                                                    <option value="belum_dikirim"
                                                        :selected="formData.status_pengiriman == 'belum_dikirim'">Belum
                                                        Dikirim
                                                    </option>
                                                    <option value="sebagian"
                                                    ...
                                                    <option value="dikirim"
                                                        :selected="formData.status_pengiriman == 'dikirim'">
                                                        Dikirim
                                                    </option>
                                                </select>
                                            </div>
