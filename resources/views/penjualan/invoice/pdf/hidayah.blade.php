...
<body>
    <div class="watermark-bg">PT HIDAYAH CAHAYA BERKAH</div>
    ...
    <table class="header-table">
        <tr style="margin-bottom: 10px;">
            <td style="width: 50%; vertical-align: middle;">
                @if ($logoBase64)
                    <img src="{{ $logoBase64 }}" alt="Logo Hidayah" style="height: 60px;">
                @endif
            </td>
            <td style="width: 50%; text-align: right; vertical-align: middle;">
                <h2 style="color: #059669; margin: 0 0 5px 0;">INVOICE #{{ $invoice->nomor }}</h2>
                <div>
        ...
        <tr>
            <td>
                ...
                <div style="padding: 5px;">
                    ...
                    Jl. Masjid Raya No. 77, Kelurahan Berkah<br>
                    Jakarta Selatan 12560<br>
                    Telp: (021) 7890-456 | Fax: (021) 7890-457<br>
                    Email: berkah@hidayahcahaya.co.id
                </div>
            </td>
            <td>
    ...
    <div style="display: flex; justify-content: space-between;">
        ...
        <div style="width: 60%;">
            @if ($invoice->catatan)
                <div
                    style="margin-bottom: 15px; border-left: 3px solid #059669; padding-left: 10px; background-color: #f8fafc;">
