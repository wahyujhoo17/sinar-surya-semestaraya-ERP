<x-app-layout :breadcrumbs="$breadcrumbs ?? []" :currentPage="$currentPage ?? 'Edit Penggajian'">
    <div class="max-w-full mx-auto py-8 sm:px-6 lg:px-8">
        ...
        {{-- Alert for Paid Payroll --}}
        @if ($penggajian->status === 'dibayar')
            <div class="mb-6 bg-amber-50 dark:bg-amber-900/20 border-l-4 border-amber-500 p-4 rounded-r-lg shadow-sm">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-amber-800 dark:text-amber-300">
                            <strong>Perhatian:</strong> Penggajian ini berstatus <strong>Dibayar Lunas</strong>{{ $penggajian->tanggal_bayar ? ' pada tanggal ' . \Carbon\Carbon::parse($penggajian->tanggal_bayar)->format('d F Y') : '' }}. Sebagai Admin/Superadmin, Anda dapat mengubah rincian gaji ini.
                        </p>
                    </div>
                </div>
            </div>
