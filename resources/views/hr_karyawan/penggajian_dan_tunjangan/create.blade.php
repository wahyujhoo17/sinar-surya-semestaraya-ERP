            ...
            <div
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <select name="bulan" id="bulan" required x-model="selectedMonth"
                            @change="calculateCommission()"
                            class="mt-1 block w-full px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-md text-sm focus:border-primary-500 focus:ring-1 focus:ring-primary-500 dark:bg-gray-800 dark:text-gray-200 transition-colors duration-200 @error('bulan') border-red-500 @enderror">
                            @for ($i = 1; $i <= 12; $i++)
                                <option value="{{ $i }}"
                                    {{ old('bulan', $selectedMonth ?? $bulanSekarang) == $i ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select name="tahun" id="tahun" required x-model="selectedYear"
                            @change="calculateCommission()"
                            class="mt-1 block w-full px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-md text-sm focus:border-primary-500 focus:ring-1 focus:ring-primary-500 dark:bg-gray-800 dark:text-gray-200 transition-colors duration-200 @error('tahun') border-red-500 @enderror">
                            @for ($i = Carbon\Carbon::now()->year - 2; $i <= Carbon\Carbon::now()->year + 1; $i++)
                                <option value="{{ $i }}"
                                    {{ old('tahun', $selectedYear ?? $tahunSekarang) == $i ? 'selected' : '' }}>
                                    {{ $i }}
                                </option>
                            @endfor
                        </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="space-y-2 text-sm">
                                ...
                                <div class="flex justify-between" x-show="parseFloat(salaryComponents.tunjangan) > 0">
                                    <span class="text-gray-600 dark:text-gray-400">Tunjangan Lainnya:</span>
                                    <span class="font-medium"
                                        x-text="formatRupiah(salaryComponents.tunjangan)"></span>
                                </div>
                                <div class="flex justify-between" x-show="parseFloat(salaryComponents.bonus) > 0">
                                ...
                                <div class="flex justify-between" x-show="parseFloat(salaryComponents.lembur) > 0">
                                ...
                                <div class="flex justify-between border-t pt-2"
                                    x-show="parseFloat(commissionData.total_commission) > 0">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="space-y-2 text-sm">
                                ...
                                <div class="flex justify-between" x-show="parseFloat(salaryComponents.potongan) > 0">
            ...
            function payrollCalculator() {
                return {
                    ...
                    salaryComponents: {
                        ...
                        tunjangan_pulsa: {{ old('tunjangan_pulsa', $salaryComponents['tunjangan_pulsa'] ?? 0) }},
                    ...
                    init() {
                        ...
                        this.$nextTick(() => {
                            const fields = ['gaji_pokok', 'tunjangan_keluarga', 'tunjangan_jabatan',
                                'tunjangan_transport', 'tunjangan_makan', 'tunjangan_btn',
                                'tunjangan_pulsa',
                    ...
                    onEmployeeChange() {
                        ...
                        if (selectedOption && selectedOption.value) {
                            ...
                            this.salaryComponents.tunjangan_pulsa = parseFloat(selectedOption.dataset.tunjanganPulsa) || 0;
                            ...
                            // Update form inputs
                            document.getElementById('gaji_pokok').value = this.formatRibu(this.salaryComponents.gaji_pokok);
                            document.getElementById('tunjangan_keluarga').value = this.formatRibu(this.salaryComponents
                                .tunjangan_keluarga);
                            document.getElementById('tunjangan_jabatan').value = this.formatRibu(this.salaryComponents
                                .tunjangan_jabatan);
                            document.getElementById('tunjangan_transport').value = this.formatRibu(this.salaryComponents
                                .tunjangan_transport);
                            document.getElementById('tunjangan_makan').value = this.formatRibu(this.salaryComponents
                                .tunjangan_makan);
                            document.getElementById('tunjangan_btn').value = this.formatRibu(this.salaryComponents
                                .tunjangan_btn);
                            document.getElementById('tunjangan_pulsa').value = this.formatRibu(this.salaryComponents
                                .tunjangan_pulsa);
                            document.getElementById('tunjangan').value = this.formatRibu(this.salaryComponents.tunjangan);
                            document.getElementById('bonus').value = this.formatRibu(this.salaryComponents.bonus);
                            document.getElementById('bpjs_karyawan').value = this.formatRibu(this.salaryComponents
                                .bpjs_karyawan);
                            document.getElementById('potongan').value = this.formatRibu(this.salaryComponents.potongan);
                    ...
                    resetForm() {
                        if (confirm('Apakah Anda yakin ingin mereset form ini?')) {
                            ...
                            this.$nextTick(() => {
                                ['gaji_pokok', 'tunjangan_keluarga', 'tunjangan_jabatan', 'tunjangan_transport',
                                    'tunjangan_makan', 'tunjangan_btn', 'tunjangan_pulsa', 'tunjangan', 'bonus',
                                    'lembur', 'bpjs_karyawan', 'cash_bon', 'keterlambatan', 'potongan'
                                ].forEach(f => {
                                    const el = document.getElementById(f);
                                    if (el) el.value = this.formatRibu(0);
                                });
                            });
                            this.commissionData = {
                                total_commission: 0,
