                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <div class="text-sm text-gray-500 dark:text-gray-400">
                            {{ $k->email }}
                            @if ($k->user && $k->user->roles->isNotEmpty())
                                <span
                                    class="ml-2 inline-flex items-center px-1.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400"
                                    title="Role pengguna">
                                    {{ $k->user->roles->first()->nama }}
                                </span>
                            @endif
                        </div>
                    </div>
